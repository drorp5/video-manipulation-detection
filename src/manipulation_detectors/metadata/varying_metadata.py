...
class FrameVaryingMetadata:
    ...
    external_timestamp_seconds: float
...
def extract_varying_metadata(frame: Frame) -> FrameVaryingMetadata:
    ...
    external_timestamp_seconds = float(frame.external_timestamp)
    return FrameVaryingMetadata(frame_id=frame_id, timestamp_seconds=timestamp_seconds, external_timestamp_seconds=external_timestamp_seconds)
